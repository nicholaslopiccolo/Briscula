...
public class ServerProtocol {
    ...
    public String route(String msg) {
        ...
        switch (header) {
            ...
            case cardBg: { broadcastBg(msg);break;}
...
//            case messagechat: { pacchetto = messageChat(msg); break;}
            ...
            default: {
                System.out.println("SERVERPROTOCOL\tERROR: BAD HEADER");
                break;
            }
        }
        return pacchetto;
    ...
    private void restartGame(String players) {
        ...
        if (p == 2) {
            if (user.getGame().TwoPBrain.nGame < 2) {
                ...
                user.getGame().TwoPBrain.restartGame(mazzo);
            } else {
...
//            user.getGame().FourPBrain.nGame++;
    ...
    private void broadcastBg(String msg) {
        user.connectedServer.broadcastMessage(msg);
        System.out.println("SERVERPROTOCOL\tSto inviando: " +msg);
    }
